...
#
# Generated by export_simulation on Tue Oct 12 16:36:49 -0300 2021
#
################################################################################
...
'-reset_run' switch to the './memoria.sh' script.

./memoria.sh -reset_run
...
./memoria.sh -noclean_files

For more information on the script, please type './memoria.sh -help'.
